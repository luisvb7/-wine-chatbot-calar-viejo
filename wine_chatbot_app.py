...
with col2:
    ...
    <a href="https://wa.me/34633343323" target="_blank" rel="noopener noreferrer" class="whatsapp-button">
        <svg viewBox="0 0 24 24" width="24" height="24" fill="white" style="flex-shrink: 0;">
